...
uint64_t wmatch_knight = 0b0000000000000000000000000100000000100000000001010010000001000000;
...
int main(int argc, char *argv[]) {
  ...
  game.wh.knights = bitmask_change(game.wh.knights, "b1a3");
  ...
  game.wh2.knights[0] = game.wh.knights & (1ULL << (23 - 0));
  game.wh2.knights[1] = game.wh.knights & (1ULL << (7 - 6));
  ...
  show_bitmask(combined_knightmove);

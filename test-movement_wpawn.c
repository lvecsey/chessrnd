...
int main(int argc, char *argv[]) {
  ...
  game.wh2.pawns[0] = game.wh.pawns & (1ULL << (31 - 0));
  game.wh2.pawns[1] = game.wh.pawns & (1ULL << (23 - 1));
  ...
  game.wh2.pawns[6] = game.wh.pawns & (1ULL << (23 - 6));
  game.wh2.pawns[7] = game.wh.pawns & (1ULL << (31 - 7));    
